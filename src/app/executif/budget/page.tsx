...
const COMPARISON_DATA = [
  ...
  { label: "Enseignement Supérieur & Recherche", val2025: 31.50, val2026: 32.12, trend: "up" },
  { label: "Solidarité et Insertion", val2025: 30.50, val2026: 31.80, trend: "up" },
  { label: "Justice", val2025: 9.60, val2026: 12.97, trend: "up" },
  { label: "Écologie & Mobilité", val2025: 27.90, val2026: 28.45, trend: "up" },
  ...
  { label: "Travail et emploi", val2025: 21.50, val2026: 21.10, trend: "down" },
  { label: "Cohésion des territoires", val2025: 18.20, val2026: 18.45, trend: "up" },
  { label: "Aide publique au développement", val2025: 5.60, val2026: 5.40, trend: "down" },
