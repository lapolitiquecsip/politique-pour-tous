...
export default function LawsPage() {
  return (
    <div className="min-h-screen bg-card text-foreground">
      ...
      <div className="relative pt-24 pb-16 md:pt-40 md:pb-32 bg-card overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10 px-4">
          ...
          >
            ...
            <h1 className="text-6xl md:text-[8.5rem] font-staatliches uppercase tracking-tight leading-none mb-10">
              <span className="text-foreground block md:inline">Tout sur les </span>
            ...
            <p className="text-lg md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-medium italic tracking-tight">
