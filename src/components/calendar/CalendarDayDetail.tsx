    ...
    <div className="h-full bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl overflow-y-auto custom-scrollbar-blue">
      ...
      {dayEvents.length === 0 ? (
        <div className="py-12 text-center text-slate-500">
          ...
          <p className="text-sm italic">Aucun évènement répertorié pour cette date.</p>
        </div>
      ) : (
        <div className="space-y-6">
          {/* All Institutions (AN, Senat, Elysee) */}
          {dayEvents.map((event, idx) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-xl font-bold mb-3 leading-snug group-hover:text-blue-400 transition-colors">
                  {event.title}
                </h4>
