...
export default function HomeHero() {
  return (
    <div className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-slate-950 overflow-hidden group min-h-[50vh] flex items-center">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-red-600/5 rounded-full blur-[80px] z-10" style={{ willChange: "filter" }} />
      <div className="absolute top-40 -left-10 w-96 h-96 bg-blue-600/10 rounded-full blur-[80px] z-10" style={{ willChange: "filter" }} />
      ...
      <div className="container mx-auto max-w-6xl text-center relative z-20 px-4">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-staatliches uppercase tracking-tight leading-none mb-6">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-white to-red-400 bg-clip-text text-transparent italic decoration-blue-500/30 underline-offset-8">c'est simple.</span>
          </h1>
