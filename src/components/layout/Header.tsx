    ...
    <header className="fixed top-0 left-0 w-full z-40 bg-white/80 backdrop-blur-md border-b border-slate-100">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-staatliches text-2xl tracking-wider uppercase leading-none pt-1">
              <span className="text-slate-900">La politique</span> <span className="bg-gradient-to-r from-amber-500 via-amber-600 to-amber-700 bg-clip-text text-transparent">c simple</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              ...
              <Link 
                href="/login"
                className="inline-flex items-center gap-2 px-5 py-2 bg-slate-900 text-white rounded-xl text-sm font-bold hover:bg-amber-500 transition-all shadow-lg shadow-slate-900/10"
              >
                <LogIn size={16} />
                Se connecter
              </Link>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <div className="pt-2">
            <Link href="/login" className="flex items-center gap-3 text-lg font-bold text-amber-600" onClick={() => setIsMenuOpen(false)}>
