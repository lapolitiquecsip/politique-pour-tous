  ...
  return (
    <section className="rounded-[2.5rem] border border-indigo-200 dark:border-indigo-900/40 bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/30 dark:to-slate-900 p-6 shadow-sm">
      <div className="mb-1 flex items-center gap-2">
        ...
        <h3 className="font-staatliches text-2xl uppercase tracking-tight text-foreground dark:text-white">Toutes ses fonctions</h3>
      </div>
      <p className="mb-4 text-sm text-muted-foreground dark:text-slate-400">Cette personne exerce ou a exercé plusieurs fonctions — retrouvez chacune d'elles ici, sans changer de fiche.</p>
