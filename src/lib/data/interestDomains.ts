...
export const INTEREST_DOMAINS: InterestDomain[] = [
  ...
  { code: "education", label: "Éducation", icon: "GraduationCap", color: "#0ea5e9",
    keywords: ["éducation", "education", "école", "ecole", "enseignant", "université", "universite", "élève", "eleve", "collège", "college", "lycée", "lycee", "bac"] },
  ...
  { code: "agriculture", label: "Agriculture & ruralité", icon: "Wheat", color: "#ca8a04",
    keywords: ["agriculture", "agricole", "agriculteur", "élevage", "elevage", "pêche", "peche", "rural", "pac", "alimentation", "ferme"] },
  ...
  { code: "europe", label: "Europe & international", icon: "Flag", color: "#3b82f6",
    keywords: ["europe", "européen", "europeen", "union européenne", "ue", "international", "défense", "defense", "otan", "diplomatie", "traité", "traite"] },
